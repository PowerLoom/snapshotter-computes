...
class FactoryMonitorProcessor(GenericProcessor):
    ...
    async def compute(
        ...
        if not module_settings.static_pairs:
            ...
            # factory address
            factory_address = module_settings.contract_addresses.uniswap_v3_factory
            ...
            for tx_receipt in relevant_txns:
                for log in tx_receipt['logs']:
                    ...
                    if log['topics'][0] == '0x783cca1c0412dd0d695e784568c96da2e9c22ff989357a2e8b1d9b2b4e6b7118':
                        try:
        ...
        await redis.sadd(uniswap_v3_monitored_pairs, *monitored_pairs)
